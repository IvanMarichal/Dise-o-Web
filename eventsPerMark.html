...
<body>
  <main class="container-main">
      <nav class="nav">
        ...
        <a href="./eventsPerMark.html" class="nav__link-group__link">
          <i class="fa-solid fa-person-running fa-xl --color-purple"></i>
        </a>
			</div> 
  ...
  <div class="main-mark --main">
    <h1 class="main-mark__header-1 --header">
      Evento
    </h1>
    <div class="main-mark__event-match">
      <div class="main-mark__event-match__group-event">
        <img src="./images/escudos/tokyo2020.png" alt="logo de evento" class="main-mark__event-match__group-event__img">
          Tokio 2020
      </div>
      <div class="main-mark__event-match__favs-img">
        <a href="#">
    ...
    <h2 class="main-mark__header-2 --header">
      Marcas
    </h2>
    <div class="main-mark__container-mark">
      <div class="main-mark__container-mark__group-selector">
        Disciplina
        <a href="#" class="main-mark__container-mark__group-selector__link --color-gray-1">
    ...
    <div class="main-mark__table-marks">
      <table class="main-mark__table-marks__table">
        <body class="main-mark__table-marks__table__body">
          <tr class="main-mark__table-marks__table__body__row">
            <td class="main-mark__table-marks__table__body__row__cell">
              <p>Puesto</p>
              <p>Equipo</p>
            </td>
            <td class="main-mark__table-marks__table__body__row__cell">
              <p>Nombre</p>
              <p id="main-mark__table-marks__table__body__row__cell__mark-id">Marca</p>
            </td>
          </tr>
          <tr class="main-mark__table-marks__table__body__row">
            <td class="main-mark__table-marks__table__body__row__cell">
              <p>Oro</p>
              <div class="main-mark__table-marks__table__body__row__cell__img-txt">
                <img src="./images/escudos/kenya.png" alt="bandera del equipo o pais">
                <p>Kenya</p>
              </div>
            </td>
            <td class="main-mark__table-marks__table__body__row__cell">
              <div class="main-mark__table-marks__table__body__row__cell__img-txt">
                <i class="fa-sharp fa-solid fa-circle fa-xl --color-gray-2"></i>
                <p>Rodrigo Garcia</p>
              </div>
              <p class="main-mark__table-marks__table__body__row__cell__mark-value">1h 31m 41.002s</p>
            </td>
          </tr> 
          <tr class="main-mark__table-marks__table__body__row">
            <td class="main-mark__table-marks__table__body__row__cell">
