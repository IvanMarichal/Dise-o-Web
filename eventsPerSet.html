...
<body>
  <main class="container-main">
    ...
    <aside class="aside-left" id="aside-left__leagues-id">
      ...
      <div class="main-set --main">
        <h1 class="main-set__header-1 --header">
            Evento
        </h1>
        <div class="main-set__event">
            <div class="main-set__event__top">
              <div class="main-set__event__top__live-sign">
                <i class="fa-solid fa-circle fa-2xs"></i>
                Live
              </div>
              <button class="main-set__event__top__add-fav">
                <i class="fa-solid fa-circle-plus fa-lg --color-gray-3"></i>
              </button>
            </div>
            <div class="main-set__event__body">
              <div class="main-set__event__body__shield-name">
                <img src="./images/escudos/barcelona.png" alt="escudo barcelona" class="main-set__event__body__shield-name__shield">
                <p class="main-set__event__body__shield-name__name">
                  Barcelona
                </p>
              </div>
              <div class="main-set__event__body__info">
                <p class="main-set__event__body__info__result">
                  1
                  <span class="main-set__event__body__info__result__colon">: </span>
                  0
                </p>
                <p class="main-set__event__body__info__minute">45'</p>
              </div>
              <div class="main-set__event__body__shield-name">
                <img src="./images/escudos/barcelona.png" alt="escudo barcelona" class="main-set__event__body__shield-name__shield">
                <p class="main-set__event__body__shield-name__name">
          ...
          <h2 class="main-set__header-2 --header">
            Puntajes
          </h2>
          <div class="main-set__scores">
              <table class="main-set__scores__table">
                <body class="main-set__scores__table__body">
                    <tr class="main-set__scores__table__body__row">
                        <td class="main-set__scores__table__body__row__cell">Set</td>
                        <td class="main-set__scores__table__body__row__cell">1</td>
                        <td class="main-set__scores__table__body__row__cell">2</td>
                        <td class="main-set__scores__table__body__row__cell">3</td>
                        <td class="main-set__scores__table__body__row__cell">4</td>
                        <td class="main-set__scores__table__body__row__cell">5</td>
                        <td class="main-set__scores__table__body__row__cell">6</td>
                    </tr>
                    <tr class="main-set__scores__table__body__row">
                        <td class="main-set__scores__table__body__row__cell">
                            <div class="main-set__scores__table__body__row__cell__team --team">
                                <img src="./images/escudos/barcelona.png" alt="escudo barceola" class="main-set__scores__table__body__row__cell__team__img">
                                Barcelona
                            </div>
                        </td>
                        <td class="main-set__scores__table__body__row__cell">1</td>
                    ...
                    <tr class="main-set__scores__table__body__row">
                        <td class="main-set__scores__table__body__row__cell">
                            <div class="main-set__scores__table__body__row__cell__team --flex-row-reverse --team">
                                <img src="./images/escudos/barcelona.png" alt="escudo barceola" class="main-set__scores__table__body__row__cell__team__img">
                                Barcelona
                            </div>
                        </td>
          ...
          <div class="main-set__progress">
            <div class="main-set__progress__ocurrences">
              <div class="main-set__progress__ocurrences__ocurrence-right">
                <p class="main-set__progress__ocurrences__ocurrence-right__minute">23'</p>
                <div class="main-set__progress__ocurrences__ocurrence-right__team-icon">
                  <div class="main-set__progress__ocurrences__ocurrence-right__team-icon__team-circle">
                    <img src="./images/escudos/barcelona.png" alt="escudo barcelona" class="main-set__progress__ocurrences__ocurrence-right__team-icon__team-circle__team">
                  </div>
                  <div class="main-set__progress__ocurrences__ocurrence-right__team-icon__icon-circle">
                    <i class="fa-solid fa-futbol --color-green"></i>
                  </div>  
                </div>
                <p class="main-set__progress__ocurrences__ocurrence-right__player">
                  Rodrigo Garcia
                </p>
              </div>
              <div class="main-set__progress__ocurrences__ocurrence-right --flex-row-reverse">
                <p class="main-set__progress__ocurrences__ocurrence-right__minute">23'</p>
                <div class="main-set__progress__ocurrences__ocurrence-right__team-icon">
                  <div class="main-set__progress__ocurrences__ocurrence-right__team-icon__team-circle">
                    <img src="./images/escudos/barcelona.png" alt="escudo barcelona" class="main-set__progress__ocurrences__ocurrence-right__team-icon__team-circle__team">
